...
print("=== GENERATING CORRECTED COLLEAGUE REPORT ===\n")
...
summary_text = [
    ...
    "• Multi-run consensus variance markers predict 71% of human-detected errors"
]
...
methodology_text = [
    ...
    "• Confidence rankings (⚠️, 🚨, [uncertain]) based on cross-run variance",
    "• Low confidence indicates high disagreement across multiple AI runs"
]
...
dataset_data = [
    ...
    ('Transcription pipeline', 'V04 with 5-run consensus + BERT variance detection')
]
...
overall_data = [
    ...
    ('Variance Marker Correlation', '71.4%', '150/210 speaker errors had variance markers')
]
...
# Consensus Pipeline Validation
ws.merge_cells(f'A{row}:E{row}')
cell = ws[f'A{row}']
cell.value = "6. MULTI-RUN CONSENSUS PIPELINE VALIDATION"
cell.font = header_font
row += 1

validation_text = [
    "The V04 pipeline's BERT-based variance detection successfully predicts human-identified errors:",
    "",
    "• 71.4% of speaker errors had variance markers (⚠️, 🚨, [uncertain])",
    "• Validates semantic variance as quality indicator",
    "• Suggests pipeline can self-identify problematic segments",
    "",
    "Implications:",
    "• Multi-run consensus method is effective for quality control",
    "• Variance markers can guide selective human review",
    "• BERT semantic similarity effective for cross-run mapping",
    "• Methodology contribution: automated quality flagging"
]
...
findings = [
    ...
    "• Multi-run consensus with BERT variance detection predicts 71% of errors",
    "• Automated quality flagging reduces need for exhaustive manual review",
    "• Cross-run semantic variance is valid quality indicator",
    "",
    ...
    "• AI transcription is viable for large-scale analysis with appropriate QC",
    ...
    "• Multi-run consensus methodology improves reliability"
]
...
next_steps = [
    ...
    "  5. Analyze variance marker performance by recording condition",
    "  6. Create visualizations (error rate by condition, inter-rater agreement)",
    "",
    "Publication:",
    "  7. Report accuracy ranges with confidence intervals",
    "  8. Include recording condition as moderating variable",
    "  9. Document multi-run consensus methodology as methodological contribution",
...
print("✅ Corrected colleague report generated!")
print(f"\nOutput file: {output_path}")
print("\nKey corrections:")
print("  • Removed 'AI self-awareness' framing")
print("  • Added multi-run consensus methodology explanation")
print("  • Reframed variance markers as pipeline validation")
print("  • Added section on methodological innovation")
print("\nReport includes:")
print("  • Executive summary")
print("  • Methodology overview (5-run consensus + BERT)")
...
print("  • Multi-run consensus pipeline validation")
print("  • Key findings")
print("  • Next steps")
